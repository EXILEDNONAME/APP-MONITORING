...
<li class="menu-item {{ (request()->is('dashboard/monitorings*')) ? 'menu-item-active' : '' }}"><a href="{{ url('/dashboard/monitorings') }}" class="menu-link"><i class="menu-icon fas fa-list-ul"></i><span class="menu-text"> Monitorings </span></a></li>